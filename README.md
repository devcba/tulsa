...
- Consulta la sección [Autenticación y flujo de inicio de sesión](docs/api-structure.md#autenticación-y-flujo-de-inicio-de-sesión) para entender cómo obtener, utilizar y revocar el token de acceso.
